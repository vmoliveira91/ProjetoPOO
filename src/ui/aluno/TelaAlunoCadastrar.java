...
public class TelaAlunoCadastrar extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaAlunoCadastrar
     */
    public TelaAlunoCadastrar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlunoCadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlunoCadastrar().setVisible(true);
            }
        });
    }
