...
public class TelaProfessorCadastrar extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaProfessorCadastrar
     */
    public TelaProfessorCadastrar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaProfessorCadastrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaProfessorCadastrar().setVisible(true);
            }
        });
    }
