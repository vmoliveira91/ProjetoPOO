...
public class TelaAdministradorAlunosRemover extends javax.swing.JFrame {
    ...
    private void removerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removerButtonActionPerformed
        ...
        try {
            if (this.fachada.removerAluno(alunoId)) {
                JOptionPane.showConfirmDialog(null, "Aluno removido com sucesso!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAdministradorAlunosRemover.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAdministradorAlunosRemover(null).setVisible(true);
            }
        });
    }
