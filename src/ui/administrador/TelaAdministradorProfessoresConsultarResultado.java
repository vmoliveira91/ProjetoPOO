...
public class TelaAdministradorProfessoresConsultarResultado extends javax.swing.JFrame {
    ...
    public TelaAdministradorProfessoresConsultarResultado(Professor professor) {
        initComponents();
    ...
    private void preencher() {
        this.idField.setText(this.professor.getId() + "");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cargoField, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAdministradorProfessoresConsultarResultado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAdministradorProfessoresConsultarResultado(null).setVisible(true);
            }
        });
    }
